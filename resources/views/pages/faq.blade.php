		...
		<div class="container-fluid p0">
		    ...
		    <nav>
		        ...
		        <a href="/" class="navbar_brand float-left dn-smd">
					<img class="logo1 img-fluid" src="images/home/web-logo.png" alt="header-logo.png" style="width: 120px; height: auto; max-width: 100%">
		            <!-- <img class="logo1 img-fluid" src="images/header-logo2.png" alt="header-logo.png"> -->
		            <img class="logo2 img-fluid" src="images/home/web-logo.png" alt="header-logo2.png" style="width: 120px; height: auto; max-width: 100%">
		        </a>
	...
	<div id="page" class="stylehome1 h0">
		<div class="mobile-menu">
			<div class="header stylehome1">
				<div class="d-flex justify-content-between">
					...
					<a class="nav_logo_img" href="https://homagency.ae/Home-page"><img class="img-fluid mt20" src="images/header-logo2.png" alt="header-logo2.png"></a>
		...
		<nav id="menu" class="stylehome1">
			<ul>
				<li><span>Home</span>
	                <ul>
	                    <li><a href="https://homagency.ae/Home-page">Home 1</a></li>
				...
				<div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
					<div class="footer_qlink_widget">
						...
						<ul class="list-unstyled">
							...
							<li><a href="https://homagency.ae/listing_page">Listing</a></li>
			<li><a href="/faq">FAQ</a></li>
				...
				<div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
					<div class="footer_contact_widget">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#">Barsha Heights, Dubai, United Arab Emirates.</a></li>
			...
			<div class="row">
				<div class="col-lg-6 col-xl-6">
					<div class="footer_menu_widget">
						<ul>
							...
							<li class="list-inline-item"><a href="https://homagency.ae/listing_page">Listing</a></li>
				...
				<div class="col-lg-6 col-xl-6">
					<div class="copyright-widget text-right">
						<p>© 2025 All Rights Reserved - Developed by <a href="https://ahdafdigital.ae/">Ahdaf Digital</a></p>
					</div>
				</div>
			</div>
		</div>
