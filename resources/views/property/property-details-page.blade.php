...
<html dir="ltr" lang="en">
  <head>
    ...
    <!-- Title -->
    <title>HOM Agency - {{ $property->title }}</title>
    <!-- Favicon -->
    <link
  ...
  <body>
    <div class="wrapper">
      ...
      <!-- Main Header Nav -->
      <header
        class="header-nav menu_style_home_one style2 navbar-scrolltofixed stricky main-menu"
      >
            ...
            >
              ...
              <li class="list-inline-item add_listing">
                <a href="page-add-new-property.html"
                  ...
                  ><span class="dn-lg"> Create Listing</span></a
                >
              </li>
            </ul>
          </nav>
                      ...
                      <form action="#">
                        ...
                        <div class="row mt25">
                          ...
                          <div class="col-lg-12">
                            ...
                            >
                              <i class="fa fa-google float-left mt5"></i> Login
                              with Google
                            </button>
                          </div>
                        </div>
                        ...
                        <div class="form-group custom-control custom-checkbox">
                          ...
                          <label
                            ...
                            >Remember me</label
                          >
                          <a class="btn-fpswd float-right" href="#"
              ...
              <div class="row m0">
                <div class="col-lg-12 p0">
                  <div class="spls_style_one pr1 1px">
                    <img
                      class="img-fluid w100"
                      src="{{ asset('storage/properties/' . $property->image) }}" alt="{{ $property->title }}"
                    />
                  </div>
                </div>
              </div>
              ...
              <div class="row m0">
                <div class="col-sm-6 col-lg-6 p0">
                  <div class="spls_style_one">
                    <a class="popup-img" href="images/property/ls2.jpg"
                      ><img
                        class="img-fluid w100"
                ...
                <div class="col-sm-6 col-lg-6 p0">
                  <div class="spls_style_one">
                    <a class="popup-img" href="images/property/ls3.jpg"
                      ><img
                        class="img-fluid w100"
                ...
                <div class="col-sm-6 col-lg-6 p0">
                  <div class="spls_style_one">
                    <a class="popup-img" href="images/property/ls4.jpg"
                      ><img
                        class="img-fluid w100"
                ...
                <div class="col-sm-6 col-lg-6 p0">
                  <div class="spls_style_one">
                    <a class="popup-img" href="images/property/ls5.jpg"
                      ><img
                        class="img-fluid w100"
          ...
          <div class="row listing_single_row">
            <div class="col-sm-6 col-lg-7 col-xl-8">
              <div class="single_property_title">
                <a href="images/property/ls1.jpg" class="upload_btn popup-img"
                  ><span class="flaticon-photo-camera"></span> View Photos</a
                >
              </div>
            </div>
              ...
              <div class="single_property_social_share">
                <div class="spss style2 mt10 text-right tal-400">
                  <ul class="mb0">
                    ...
                    <li class="list-inline-item">
                      <a href="#"><span class="flaticon-share"></span></a>
                    </li>
                    <li class="list-inline-item">
                      <a href="#"><span class="flaticon-printer"></span></a>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-md-12 col-lg-8 mt50">
              <div class="row">
                <div class="col-lg-12">
                  <div class="listing_single_description2 mt30-767 mb30-767">
                    ...
                    <div class="single_property_social_share style2">
                      <div class="price">
                        <h2>${{ number_format($property->price, 2) }}<small>/mo</small></h2>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-lg-12">
                  <div class="listing_single_description style2">
                   ...
                   /* <p class="gpara second_para white_goverlay mt10 mb10">
                      ...
                      lovely natural light to fill every room. The master suite
                      is surrounded by handcrafted milkwork and features
                    ...
                    <div class="collapse" id="collapseExample">
                      <div class="card card-body">
                        <p class="mt10 mb10">
                          ...
                          allow for lovely natural light to fill every room. The
                  ...
                  <div class="additional_details">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-6 col-xl-4">
                        ...
                        <ul class="list-inline-item">
                          <li>
                            <p><span>{{ $property->property_id }}</span></p>
                          </li>
                          <li>
                            <p><span>${{ number_format($property->price, 2) }}</span></p>
                          </li>
                          <li>
                            <p><span>{{ $property->property_size }} Sq Ft</span></p>
                          </li>
                          <li>
                            <p><span>{{ $property->year_built }}</span></p>
                          </li>
                        </ul>
                      </div>
                      <div class="col-md-6 col-lg-6 col-xl-4">
                        ...
                        <ul class="list-inline-item">
                          <li>
                            <p><span>{{ $property->bedrooms }}</span></p>
                          </li>
                          <li>
                            <p><span>{{ $property->bathrooms }}</span></p>
                          </li>
                          <li>
                            <p><span>{{ $property->garage }}</span></p>
                          </li>
                          <li>
                            <p><span>{{ $property->garage_size }} SqFt</span></p>
                          </li>
                        </ul>
                      </div>
                      <div class="col-md-6 col-lg-6 col-xl-4">
                        <ul class="list-inline-item">
                          ...
                          <li><p>Handover Date :</p></li>
                        </ul>
                        <ul class="list-inline-item">
                          <li>
                            <p><span>{{ $property->property_type }}</span></p>
                          </li>
                          <li>
                            <p><span>{{ $property->property_status }}</span></p>
                          </li>
                          <li>
                            <p><span>{{ $property->completion_status }}</span></p>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div class="additional_details">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-6">
                        ...
                        <ul class="list-inline-item">
                          <li>
                            <p><span>{{ $property->deposit }}%</span></p>
                          </li>
                          <li>
                            <p><span>{{ $property->pool_size }} Sqft</span></p>
                          </li>
                          <li>
                            <p><span>{{ $property->additional_rooms }}</span></p>
                          </li>
                        </ul>
                      </div>
                      <div class="col-md-6 col-lg-6">
                        ...
                        <ul class="list-inline-item">
                          <li>
                            <p><span>{{ $property->last_remodel_year }}</span></p>
                          </li>
                          <li>
                            <p><span>{{ $property->amenities }}</span></p>
                          </li>
                          <li>
                            <p><span>{{ $property->equipment }}</span></p>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div class="property_attachment_area">
                    ...
                    <div class="iba_container style2">
                      <div class="icon_box_area style2">
                        <div class="score">
                          <span class="flaticon-document text-thm fz30"></span>
                        </div>
                        <div class="details">
                          <h5>
                            <span
                              class="flaticon-download text-thm pr10"
                            ></span>
                            Demo Word Document
                          </h5>
                        </div>
                      ...
                      <div class="icon_box_area style2">
                        <div class="score">
                          <span class="flaticon-pdf text-thm fz30"></span>
                        </div>
                        <div class="details">
                          <h5>
                            <span
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 col-md-6 col-lg-4">
                        <ul class="order_list list-inline-item">
                          <li>
                            <a href="#"
                              ><span class="flaticon-tick"></span>{{ $property->features }}</a
                            >
                          </li>
                          <li>
                            <a href="#"
                      ...
                      <div class="col-sm-6 col-md-6 col-lg-4">
                        <ul class="order_list list-inline-item">
                          ...
                          <li>
                            <a href="#"
                              ><span class="flaticon-tick"></span>{{ $property->features }}
                              </a
                            >
                          </li>
                        </ul>
                  ...
                  <div class="application_statics mt30">
                    <h4 class="mb30">
                      ...
                      <small class="float-right"
                        >1421 San Pedro St, Los Angeles, CA 90015</small
                      >
                    </h4>
                ...
                <div class="col-lg-12">
                  <div class="shop_single_tab_content style2 mt30">
                    ...
                    <div class="tab-content" id="myTabContent2">
                      ...
                      >
                        <div class="property_video">
                          <div class="thumb">
                            ...
                            <div class="overlay_icon">
                              <a
                                class="video_popup_btn red popup-youtube"
                      ...
                      <div
                        class="tab-pane fade row pl15 pl0-1199 pr15 pr0-1199"
                        id="listing"
                        role="tabpanel"
                        ...
                        <div class="property_video">
                          <div class="thumb">
                            ...
                            <div class="overlay_icon">
                              <a
                                class="video_popup_btn red popup-youtube"
                                href="https://www.youtube.com/watch?v=Jrs5yji5bb0"
                                ><span class="flaticon-play"></span
                              ></a>
                            </div>
                          </div>
                ...
                <div class="col-lg-12">
                  <div class="whats_nearby mt30">
                    ...
                    <div class="education_distance mb15">
                      <h5>
                        <span class="flaticon-college-graduation"></span>
                        Education
                      </h5>
                      <div class="single_line">
                        <p class="para">
                          Eladia's Kids <span>(3.13 miles)</span>
                        </p>
                        <ul class="review">
                          <li class="list-inline-item">
                          ...
                          <li class="list-inline-item">
                            <span class="total_rive_count">8895 reviews</span>
                          </li>
                        </ul>
                      </div>
                      <div class="single_line">
                        <p class="para">
                          Gear Up With ACLS <span>(4.66 miles)</span>
                        </p>
                        <ul class="review">
                          <li class="list-inline-item">
                            <a href="#"><i class="fa fa-star"></i></a>
                          ...
                          <li class="list-inline-item">
                            <span class="total_rive_count">7475 reviews</span>
                          </li>
                        </ul>
                      </div>
                      <div class="single_line">
                        <p class="para">
                          Brooklyn Brainery <span>(3.31 miles)</span>
                        </p>
                        <ul class="review">
                          <li class="list-inline-item">
                            <a href="#"><i class="fa fa-star"></i></a>
                          ...
                          <li class="list-inline-item">
                            <span class="total_rive_count">3579 reviews</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div class="education_distance mb15 style2">
                      <h5>
                        <span class="flaticon-heartbeat"></span> Health &
                        Medical
                      </h5>
                      <div class="single_line">
                        <p class="para">
                    ...
                    <div class="education_distance style3">
                      <h5>
                        <span class="flaticon-front-of-bus"></span>
                        Transportation
                      </h5>
                      <div class="single_line">
                        <p class="para">
                ...
                <div class="col-lg-12">
                  <div class="application_statics">
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-xl-6">
                        <div
                          class="my_profile_setting_input ui_kit_select_search form-group"
                        >
                          <select
                            class="selectpicker"
                            data-live-search="true"
                ...
                <div class="col-lg-12">
                  <div
                    class="application_statics shop_single_tab_content style3 mt30"
                  >
                    <ul
                      class="nav nav-tabs float-right fn-414"
                      id="myTab"
                      role="tablist"
                    >
                      <li class="nav-item">
                    ...
                    <div class="mbp_pagination_comments mt30">
                      <div class="mbp_comment_form style2">
                        ...
                        <ul class="sspd_review">
                          ...
                          <li class="list-inline-item review_rating_para">
                            Your Rating & Review
                          </li>
                        </ul>
                          ...
                          <div class="panel-heading">
                            <h4 class="panel-title">
                              <a
                                ...
                                ><i class="flaticon-more"></i> Advanced
                                features</a
                              >
                            </h4>
                          </div>
                  ...
                  <ul class="list_details">
                    <li>
                      <a href="#"
                        ...
                        <span class="float-right">6 properties</span></a
                      >
                    </li>
                    <li>
                      <a href="#"
                        ><i class="fa fa-caret-right mr10"></i>Condo
                        <span class="float-right">12 properties</span></a
                      >
                    </li>
                    <li>
                      <a href="#"
                        ><i class="fa fa-caret-right mr10"></i>Family House
                        <span class="float-right">8 properties</span></a
                      >
                    </li>
                    <li>
                      <a href="#"
                        ><i class="fa fa-caret-right mr10"></i>Modern Villa
                        <span class="float-right">26 properties</span></a
                      >
                    </li>
                    <li>
                      <a href="#"
                        ><i class="fa fa-caret-right mr10"></i>Town House
                        <span class="float-right">89 properties</span></a
                      >
                    </li>
                  </ul>
                </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
              <div class="footer_contact_widget">
                ...
                <ul class="list-unstyled">
                  ...
                  <li><a href="#">Dubai - Al Barsha Heigths</a></li>
                  <li><a href="#">0000, United Arab Emirates.</a></li>
                  <li><a href="#">+971 56 477 7039</a></li>
                </ul>
              </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-xl-6">
              <div class="copyright-widget text-right">
                <p>© 2025 HOM Agency - Developed by Ahdaf Digital.</p>
              </div>
            </div>
          </div>
        </div>
